...
@section('title', 'Edit Paket Bandwidth')

@section('content')
<div class="card border-0 shadow-sm rounded-3 border border-dark mt-3">
    <div class="card-header bg-white">
        <h5 class="mb-0 fw-bold">Edit Paket Bandwidth</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('bandwidth.update', $paket) }}" method="POST" class="row g-3">
            @csrf
            @method('PUT')
            <div class="col-md-6">
            ...
            <div class="col-md-3">
                ...
                <input type="text" name="limit_download" value="{{ old('limit_download', $paket->limit_download) }}" class="form-control" required>
            </div>
            <div class="col-md-3">
                <label class="form-label">Limit Upload</label>
                <input type="text" name="limit_upload" value="{{ old('limit_upload', $paket->limit_upload) }}" class="form-control" required>
            </div>
            <div class="col-md-4">
